...
class MixGCF_NonConcat_Egress(GraphRecommender):
    def __init__(self, conf, training_set, test_set):
        super(MixGCF_NonConcat_Egress, self).__init__(conf, training_set, test_set)
        args = OptionConf(self.config['MixGCF_NonConcat_Egress'])
