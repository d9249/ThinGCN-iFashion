...
class GraphRecommender(Recommender):
    ...
    def fast_evaluation(self, epoch):
        ...
        wandb.log({
            "Hit Ratio": float(self.bestPerformance[1]['Hit Ratio']),
            "Precision": float(self.bestPerformance[1]['Precision']),
            "Recall": float(self.bestPerformance[1]['Recall']),
            "NDCG": float(self.bestPerformance[1]['NDCG']),
            "Current Epoch": float(epoch + 1),
            "Best Performance Epoch": float(self.bestPerformance[0])
            # "Best Performance": bp
            # "Best Hit Ratio": str(self.bestPerformance[0]['Hit Ratio']),
            # "Best Precision": str(self.bestPerformance[0]['Precision']),
            # "Best Recall": str(self.bestPerformance[0]['Recall']),
            # "Best NDCG": str(self.bestPerformance[0]['NDCG'])
        })
