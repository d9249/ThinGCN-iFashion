...
class Interaction(Data,Graph):
    ...
    def training_size(self):
        wandb.init(
            config={
                "Training Set User number": len(self.user), 
                "Train Set Item number": len(self.item), 
                "Train Set interaction number": len(self.training_data)
            }
        )
    ...
    def test_size(self):
        wandb.init(
            config={
                "Test Set User number": len(self.test_set), 
                "Test Set Item number": len(self.test_set_item), 
                "Test Set interaction number": len(self.test_data)
            }
        )
